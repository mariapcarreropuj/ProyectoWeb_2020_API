...
#     'authorization': 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJibGFjayIsImlkZW50aXR5IjoiYmxhY2siLCJhdXRob3JpdGllcyI6WyJST0xFX1VTRVIiXSwiaWF0IjoxNjAzNDI0NTY1LCJleHAiOjE2MDM0MjUxNjV9.UV8DczPyZLsUmnmJlSttrej8i-5NX5bOQkQReqgiP2gt1YWWyIPqd_hWLi1rfLp06lKGm_NBizpsjLsVvDAJOw'
# }
# conn.request("GET", "/users/3", headers=headers)
